...
public class LoanVariableShowTablePanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public LoanVariableShowTablePanel(LoanVariable l) {
	    ...
	    int size = this.loanVariable.getTotalDuration();
	    
	    jTable = new JTable(tblModel);
	    jTable.setSize(915, 576);
	    
	    double ca = this.loanVariable.getAmount();
	    
	    for (int i = 0; i < size; i++) {
	    	Object[] o = new Object[] {
	    		i,
	    		"date",
	    		this.loanVariable.getRates().get(0).getMonthlyPayment(),
	    		"capital amorti",
	    		"Intérêt",
	    		"Assurance",
	    		ca
	    	...
	    	ca = ca - this.loanVariable.getRates().get(0).getMonthlyPayment();
	    }
